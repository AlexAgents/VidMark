...
def build_exe(args=None) -> bool:
    ...
    if not os.path.exists(style_qss):
        print_warn("assets/style.qss not found")
...
def main():
    ...
    ui_group.add_argument("--console", action="store_true", help="Force console")
    ui_group.add_argument("--windowed", action="store_true", help="Force windowed")
